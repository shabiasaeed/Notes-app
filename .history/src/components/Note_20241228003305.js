...
import { ThumbTackIcon } from '@heroicons/react/solid'; // Solid for the pinned state
import { ThumbTackIcon as ThumbTackOutlineIcon } from '@heroicons/react/outline'; // Outline for unpinned/hover state
